...
export function TableRow({
  ...
  return (
    <tr
      className={cn(
        "border-b transition-colors hover:bg-neutral-100/50 data-[state=selected]:bg-neutral-100 dark:border-black-300 dark:hover:bg-black-800 dark:data-[state=selected]:bg-neutral-800",
        className,
      )}
      {...props}
    />
